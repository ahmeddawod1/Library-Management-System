            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case "3":
                        ...
                        Person absMember = library.findmember(mid);
                        Book bookToBorrow = library.findBook(bid);

                        if (absMember is User m1 && bookToBorrow != null)
                            m1.Borrwed_Books(bookToBorrow);
                        else
                    ...
                    case "4":
                        ...
                        absMember = library.findmember(mid);
                        Book bookToReturn = library.findBook(bid);

                        if (absMember is User m2 && bookToReturn != null)
                            m2.Return_Books(bookToReturn);
                        else
                            Console.WriteLine("Invalid member or book ID.");
                        break;
